...
const MonthwiseSupplierOutstanding = () => {
    ...
    const fetchPayments = async () => {
      ...
      try {
        const response = await axios.post(
          `${BASE_URL}/api/panel-fetch-supplier-outstanding-monthwise-report`,
          {
            from_date,
            to_date,
            billing_to_id,
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "MonthWise Supplier Outstanding Report",
    pageStyle: `
      @page {
        margin: 2mm;
      }
  ...
  const handlePdfDownload = () => {
    ...
    const docDefinition = {
      content: [
        {
          text: "MonthWise Supplier Outstanding Report",
          style: "header",
          alignment: "center",
        },
        ...content,
    ...
    pdfMake.createPdf(docDefinition).download("Monthwise_Supplier_Outstanding_Report.pdf");
  };
  ...
  const downloadReport = async () => {
    try {
      ...
      const res = await axios.post(
        `${BASE_URL}/api/panel-download-supplier-outstanding-monthwise-report`,
        {
          from_date,
          to_date,
          billing_to_id,
      ...
      link.setAttribute("download", "Monthwise_Supplier_Outstanding_Report.csv");
      document.body.appendChild(link);
      link.click();

      toast.success("Monthwise Supplier Outstanding Report downloaded successfully");
    } catch (err) {
    ...
    <Layout>
        ...
        <div className="p-6 max-w-screen bg-white">
                <div ref={reportRef} className="bg-white">
                  ...
                  >
                    MonthWise Supplier Outstanding Report
                  </Title>
...
export default MonthwiseSupplierOutstanding